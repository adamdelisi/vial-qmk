f/* Copyright 2020 Victor Lucachi
 *
...
[_QWERTY] = LAYOUT_void_ergo(
    ...
    KC_LSFT,    KC_Z,     KC_X,     nnnnKC_C,       KC_V,     KC_B,                     KC_N,       KC_M,     KC_COMM,    KC_DOT,   KC_SLSH,  KC_RSFT,
                KC_MPLY,  KC_LALT,  KC_LCTL, MO(_LOWER),   KC_TRNS,                  KC_TRNS,   KC_SPC,   MO(_RAISE), KC_RGUI,  KC_MUTE
),
